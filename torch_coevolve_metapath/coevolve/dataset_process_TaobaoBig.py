...
print(len(item_list))
click_writer.close()
user_total_number=len(user_list)
item_total_number=len(item_list)
with open('./Taobao_Big/user_item_number.txt', 'w') as f:
    f.write('userNum:'+str(user_total_number))
    f.write('\n')
    f.write('itemNum:' + str(item_total_number))
f.close()
