...
small_userprofile_entity='./data/Taobao/small_user_profile_entity.csv'
...
cate_2entity='./data/Taobao/cate_index2entity_id.txt'
campaign_2entity='./data/Taobao/campaign_index2entity_id.txt'
brand_2entity='./data/Taobao/brand_index2entity_id.txt'
price_2entity='./data/Taobao/price_index2entity_id.txt'
...
item_kg='./data/Taobao/kg.txt'

user_kg='./data/Taobao/kg_user.txt'
